...
@misc{rwa2026,
  title={Tokenized Asset Dashboard},
  author={{RWA.xyz}},
  year={2026},
...
Documents were collected from four sources, as shown in \cref{tab:sources}.
...
Blockchain research output has grown every year since 2015 without exception, as shown in \cref{tab:yearly}.
...
The ten most frequent single keywords across all 100,024 document titles are shown in \cref{tab:keywords}.
...
This convergence has practical implications for healthcare (where patient data cannot leave hospital networks), financial services (where competing institutions need to train fraud detection models on shared patterns without sharing underlying transaction data), and supply chain optimization.

\subsection{Limitations}

Title-level analysis has clear limitations. It cannot capture the quality or methodology of individual papers. Citation counts from Crossref are incomplete, as some publishers do not report citation data. The 2026 cohort covers only January through May.
