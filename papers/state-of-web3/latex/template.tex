...
The complete dataset is available at \url{https://vedangvatsa.com/web3-reports}.

\section*{References}

\begin{enumerate}
\item S.\ Nakamoto, ``Bitcoin: A Peer-to-Peer Electronic Cash System,'' 2008. \url{https://bitcoin.org/bitcoin.pdf}

\item V.\ Buterin, ``Ethereum: A Next-Generation Smart Contract and Decentralized Application Platform,'' 2014. \url{https://ethereum.org/whitepaper}
...
\item European Central Bank, ``Digital Euro Project,'' 2024. \url{https://www.ecb.europa.eu/paym/digital_euro/html/index.en.html}

\item U.S.\ Congress, ``GENIUS Act,'' 2025. \url{https://www.congress.gov}

\item European Union, ``Markets in Crypto-Assets Regulation (MiCA),'' 2023. \url{https://eur-lex.europa.eu}

\item RWA.xyz, ``Tokenized Asset Dashboard,'' 2026. \url{https://www.rwa.xyz}

\item A.\ Firdaus et al., ``Root causes of blockchain research: A bibliometric analysis,'' \textit{Telematics and Informatics}, vol.\ 36, pp.\ 46--54, 2019.
\end{enumerate}
