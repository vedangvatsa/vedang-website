...
import { AgentreadyLeaderboard } from '@/components/mdx/agentready-charts';
type Props = {
  ...
  return (
    <PageLayout>
      ...
      <div className="pb-10 md:pb-14">
          <article className="notion-article prose prose-lg prose-neutral max-w-none mx-auto min-w-0">
          <MDXRemote
