...
import { IndiaAIPillarAllocation, IndiaAIFundsReleased, IndiaAIComputeFunnel, IndiaAIUserCounts, IndiaAIGPUPriceTable, IndiaAIClaimsTable } from '@/components/mdx/indiaai-charts';
