        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mx-auto max-w-4xl mb-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search across 19,000+ reports by title, source, or topic..."
                value={searchQuery}
                onChange={(e) => handleFilterChange(setSearchQuery, e.target.value)}
                className="w-full rounded-xl border bg-card px-12 py-4 text-base placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all shadow-sm"
                id="search-reports"
              />
              <button
