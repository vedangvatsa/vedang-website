...
const speakingImages = [
  '/images/speaker/Vedang - speaker1.webp', '/images/speaker/Vedang - speaker2.webp',
  '/images/speaker/Vedang - speaker3.webp', '/images/speaker/Vedang - speaker4.webp',
  '/images/speaker/Vedang - speaker5.webp', '/images/speaker/Vedang - speaker6.webp',
  '/images/speaker/Vedang - speaker7.webp', '/images/speaker/Vedang - speaker8.webp',
  '/images/speaker/Vedang - speaker9.webp', '/images/speaker/Vedang - speaker10.webp',
  '/images/speaker/Vedang - speaker11.webp', '/images/speaker/Vedang - speaker12.webp',
  '/images/speaker/Vedang - speaker13.webp', '/images/speaker/Vedang - speaker14.webp',
  '/images/speaker/Vedang - speaker15.webp', '/images/speaker/Vedang - speaker16.webp',
  '/images/speaker/Vedang - speaker17.webp', '/images/speaker/Vedang - speaker18.webp',
  '/images/speaker/Vedang - speaker19.webp', '/images/speaker/Vedang - speaker20.webp',
  '/images/speaker/Vedang - speaker21.webp', '/images/speaker/Vedang - speaker22.jpg',
  '/images/speaker/Vedang - speaker23.jpg', '/images/speaker/Vedang - speaker24.jpeg',
  '/images/speaker/Vedang - speaker25.jpeg', '/images/speaker/Vedang - speaker26.jpg',
  '/images/speaker/Vedang - speaker27.jpeg', '/images/speaker/Vedang - speaker28.jpeg',
];
  ...
  return (
    <PageLayout>
      ...
      <div className="container mx-auto max-w-3xl px-4 md:px-6 py-12">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight">Speaking & media</h1>
        <p className="mt-2 text-muted-foreground leading-relaxed">
          Frequent speaker at international conferences, academic institutions, and corporate events on AI, Web3, and the future of technology.
        </p>

        <section className="mt-12">
          <h2 className="text-2xl font-semibold tracking-tight border-b border-border pb-2">Invited at the Parliament of India</h2>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold tracking-tight border-b border-border pb-2">Speaking engagements</h2>
          <div className="columns-2 sm:columns-3 gap-3 mt-6">
            {speakingImages.map((src, i) => (
              <div key={i} className="mb-3 break-inside-avoid">
                <Image src={src} alt={`Speaking engagement ${i + 1}`} width={500} height={500} className="rounded-md object-cover w-full h-auto" />
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold tracking-tight border-b border-border pb-2">Media mentions</h2>
          <div className="mt-6 space-y-1">
            {mediaMentions.map((m, i) => (
              <Link key={i} href={m.url} target="_blank" rel="noopener noreferrer" className="group flex items-start justify-between gap-2 rounded-md px-2 py-2 -mx-2 transition-colors hover:bg-muted/50">
                <div>
                  <span className="text-sm font-medium group-hover:text-foreground">{m.title}</span>
                  <span className="text-xs text-muted-foreground ml-2">{m.source}</span>
                </div>
                <MoveUpRight className="h-3 w-3 text-muted-foreground shrink-0 mt-1" />
              </Link>
            ))}
          </div>
        </section>
