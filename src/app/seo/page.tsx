    ...
    <PageLayout>
      ...
      >
        ...
        <section className="my-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Card className="text-center p-4 bg-secondary/30">
            <p className="text-3xl font-bold">~90M</p>
            <p className="mt-2 text-sm text-muted-foreground">Annual Content Reach (LinkedIn + Telegram)</p>
          </Card>
        </section>

        <div className="space-y-8">
          <section id="competencies">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Core Competencies & Experience</h2>
            <div className="grid md:grid-cols-2 gap-x-6 gap-y-4">
              <div>
                <h3 className="font-semibold text-lg">SEO & Website Management</h3>
                <p className="text-muted-foreground mt-2 text-sm">Achieved top 3 Google SERP rankings for target keywords within 4 months through advanced SEO roadmap execution. Managed web properties achieving 2.3M+ views and a Google PageSpeed score of 98.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">ASO & Mobile Growth</h3>
                <p className="text-muted-foreground mt-2 text-sm">Optimized app visibility and conversion using App Store Connect and Sensor Tower, driving user acquisition and retention for iOS and Android platforms.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">Data-driven Experimentation</h3>
                <p className="text-muted-foreground mt-2 text-sm">Executed high-velocity A/B testing, funnel optimization, and lifecycle initiatives using GA4, Adjust, and Firebase to drive continuous performance improvements.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">Paid Acquisition & Performance Media</h3>
                <p className="text-muted-foreground mt-2 text-sm">Planned and executed paid campaigns across Meta, Google, and YouTube, focusing on cost-effective user acquisition and measurable ROI.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">Community & Content Marketing</h3>
                <p className="text-muted-foreground mt-2 text-sm">Founded and scaled a 100,000+ member Web3 professional community, using a content strategy that generates ~90 million annual impressions to drive organic user acquisition.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">Cross-Functional Leadership</h3>
                <p className="text-muted-foreground mt-2 text-sm">8 years of professional experience, including growing a team from 3 to 28. Ex-KPMG & EY consultant with extensive experience working with product, engineering, and brand teams in fast-paced remote environments.</p>
              </div>
            </div>
          </section>
          
          <section id="toolkit">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Technical & Creative Toolkit</h2>
          ...
          <section id="experience">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Professional Experience</h2>
          ...
          <section id="qualifications">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Qualifications & Recognition</h2>
            <Card>
      ...
      <div className="py-8">
        <div className="space-y-8">
          <section id="testimonials">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Testimonials</h2>
          ...
          <section id="papers-essays">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-5">Recent Papers & Essays</h2>
