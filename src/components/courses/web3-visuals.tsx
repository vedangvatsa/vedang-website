      ...
      <div className="p-5 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {[
            ...
            <div key={e.era} className="rounded-[3px] border border-[#e3e3e0] overflow-hidden" style={{ borderTopWidth: '3px', borderTopColor: e.color }}>
              <div className="p-3">
                ...
                <div className="text-[11px] font-semibold text-[#37352f] mb-1">{e.model}</div>
    ...
    <figure className="not-prose my-8 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-5 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {props.map((p) => (
            <div key={p.title} className="rounded-[3px] border border-[#e3e3e0] p-3">
              <span className="text-xs font-bold text-[#37352f]">{p.title}</span>
  ...
  return (
    <figure className="not-prose my-8 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-5 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {pillars.map((p) => (
            <div key={p.title} className="rounded-[3px] border border-[#e3e3e0] overflow-hidden" style={{ borderLeftWidth: '3px', borderLeftColor: p.color }}>
              <div className="px-4 py-2.5">
            ...
            {steps.map((s) => (
              <div key={s.num} className="grid grid-cols-[36px_1fr] gap-3 items-start">
                ...
                <div className="rounded-[3px] border border-[#e3e3e0] p-3">
                  ...
                  {s.warning && <p className="text-[10px] text-red-500 mt-0.5 font-semibold">{s.warning}</p>}
                </div>
              </div>
            ))}
          </div>
  ...
  return (
    <figure className="not-prose my-8 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-5 md:p-8">
        ...
        <div className="mb-4 rounded-[3px] bg-[#f7f6f3] px-4 py-2.5">
          <span className="text-[11px] text-[#37352f]"><strong>Ethereum L1:</strong> ~15 TPS, $1-50+ per tx. L2s batch hundreds of transactions and post proofs back to L1.</span>
        </div>
      ...
      <div className="p-5 md:p-8">
        ...
        <div className="overflow-x-auto -mx-2">
          <table className="w-full text-xs border-collapse min-w-[400px]">
            ...
            <tbody>
              {types.map((t) => (
                <tr key={t.label} className="border-b border-[#e3e3e0]/60">
  ...
  return (
    <figure className="not-prose my-8 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-5 md:p-8">
        ...
        <div className="space-y-1.5">
          {platforms.map(p => (
            <div key={p.name} className="rounded-[3px] border border-[#e3e3e0] px-4 py-2.5 flex items-center gap-3" style={{ borderLeftWidth: '3px', borderLeftColor: p.color }}>
      ...
      <div className="p-5 md:p-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[11px]">
            ...
            <tbody>
              {wallets.map(w => (
                <tr key={w.name} className="border-b border-[#e3e3e0]/40">
...
export function RegulationMap() {
  ...
  return (
    <figure className="not-prose my-8 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-5 md:p-8">
        <h3 className="text-base md:text-lg font-bold tracking-tight mb-0.5 text-[#37352f]">Global Regulatory Landscape</h3>
      ...
      <div className="p-5 md:p-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[11px]">
            ...
            <tbody>
              {l2s.map(l => (
                <tr key={l.name} className="border-b border-[#e3e3e0]/40">
