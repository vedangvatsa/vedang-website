  ...
  return (
    <figure className="not-prose my-10 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-6 md:p-10">
        <h3 className="text-lg md:text-xl font-bold tracking-tight mb-1 text-[#37352f]">The Blockchain Ecosystem (March 2026)</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#37352f]">$93B</div>
            <div className="text-xs text-[#37352f] font-medium mt-1">DeFi TVL</div>
            <div className="text-[10px] text-muted-foreground mt-0.5">Down from $180B peak</div>
          </div>
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#37352f]">$85.8B</div>
            <div className="text-xs text-[#37352f] font-medium mt-1">Bitcoin ETF AUM (US)</div>
          ...
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#37352f]">$40-72B</div>
...
export function BlockchainPhases() {
  ...
  return (
    <figure className="not-prose my-10 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-6 md:p-10">
        <h3 className="text-lg md:text-xl font-bold tracking-tight mb-1 text-[#37352f]">Five Phases of Blockchain</h3>
          ...
          <table className="w-full text-xs border-collapse min-w-[550px]">
            <thead>
              <tr className="border-b-2 border-[#e3e3e0]">
                ...
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Phase</th>
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Key achievement</th>
      ...
      <div className="p-6 md:p-10">
        ...
        <div className="overflow-x-auto -mx-2">
          <table className="w-full text-xs border-collapse min-w-[520px]">
            <thead>
              <tr className="border-b-2 border-[#e3e3e0]">
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Network</th>
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">TVL</th>
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Tx share</th>
          ...
          <table className="w-full text-xs border-collapse min-w-[520px]">
            <thead>
              <tr className="border-b-2 border-[#e3e3e0]">
                ...
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Framework</th>
                <th className="text-left py-2 px-2 font-bold text-[#37352f] uppercase tracking-wider">Key requirement</th>
