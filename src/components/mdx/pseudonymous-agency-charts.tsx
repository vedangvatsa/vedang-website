    ...
    <figure className="not-prose my-10 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-6 md:p-10">
        ...
        <div className="space-y-4">
          {spectra.map((s) => (
            <div key={s.type} className="rounded-[3px] border border-[#e3e3e0] p-3" style={{ borderLeftWidth: '3px', borderLeftColor: s.color }}>
              ...
              <div className="w-full h-2 bg-[#f7f6f3] rounded-md overflow-hidden mb-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-1 text-[9px]">
                <div><span className="text-muted-foreground">Persistence:</span> <span className="font-medium text-[#37352f]">{s.persistence}</span></div>
                <div><span className="text-muted-foreground">Reputation:</span> <span className="font-medium text-[#37352f]">{s.reputation}</span></div>
                <div><span className="text-muted-foreground">Accountability:</span> <span className="font-medium text-[#37352f]">{s.accountability}</span></div>
                <div><span className="text-muted-foreground">Privacy:</span> <span className="font-medium text-[#37352f]">{s.privacy}</span></div>
                <div><span className="text-muted-foreground">Barrier:</span> <span className="font-medium text-[#37352f]">{s.barrier}</span></div>
                <div><span className="text-muted-foreground">Trust:</span> <span className="font-medium text-[#37352f]">{s.trustMech}</span></div>
              </div>
            </div>
          ))}
        </div>
    ...
    <figure className="not-prose my-10 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-6 md:p-10">
        ...
        <div className="space-y-2">
          {cases.map((c) => (
            <div key={c.name} className="grid grid-cols-[120px_1fr_100px] gap-2 items-center border-b border-[#e3e3e0] pb-2 last:border-0">
              <div>
              ...
              <div>
                <span className="text-[10px] text-[#37352f]">{c.achievement}</span>
          ...
          {infra.map((i) => (
            <div key={i.name}>
              <div className="flex items-baseline justify-between mb-1">
                <span className="text-[11px] font-bold text-[#37352f]">{i.name}</span>
  ...
  return (
    <figure className="not-prose my-10 w-full rounded-[3px] border border-[#e3e3e0] bg-white overflow-hidden">
      <div className="p-6 md:p-10">
        ...
        <div className="space-y-2">
          {groups.map((g) => (
            <div key={g.group} className="rounded-[3px] border border-[#e3e3e0] p-3" style={{ borderLeftWidth: '3px', borderLeftColor: g.color }}>
              <div className="flex items-baseline justify-between mb-1">
                <span className="text-[11px] font-bold text-[#37352f]">{g.group}</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-1 text-[9px]">
                <div><span className="text-muted-foreground">Barrier:</span> <span className="text-[#37352f]">{g.barrier}</span></div>
                ...
                <div><span className="text-muted-foreground">Example:</span> <span className="text-[#37352f]">{g.example}</span></div>
              </div>
            </div>
          ))}
        </div>
