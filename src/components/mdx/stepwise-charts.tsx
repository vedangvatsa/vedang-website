    ...
    <figure className="not-prose chart-card">
      <div className="p-6 md:p-10">
        ...
        <div className="flex flex-col gap-4">
          {stages.map((s, index) => (
            <div key={s.num} className={`p-4 rounded border ${index === 3 ? 'border-[#18181b]/50 bg-[#f4f4f5]' : 'border-[#e3e3e0]'} relative`}>
              <div className="absolute top-4 right-4 text-[10px] font-bold px-2 py-1 bg-[#f7f6f3] text-muted-foreground rounded">
                Stage {s.num}
              </div>
              <div className="font-bold text-[#37352f] text-base mb-1">{s.name}</div>
              <div className="text-xs text-[#18181b] font-semibold mb-2">{s.time} • {s.impact} Impact</div>
      ...
      <div className="p-6 md:p-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center">
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#18181b]">50%</div>
            <div className="text-[10px] text-[#37352f] font-medium mt-1 uppercase">Capacity Increase</div>
          ...
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            ...
            <div className="text-[10px] text-[#37352f] font-medium mt-1 uppercase">Response Time</div>
            <div className="text-[10px] text-muted-foreground mt-2">Sales voice agent qualification</div>
          </div>
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#18181b]">300%</div>
            <div className="text-[10px] text-[#37352f] font-medium mt-1 uppercase">Lead Conversions</div>
            <div className="text-[10px] text-muted-foreground mt-2">After business hours engagement</div>
          </div>
          <div className="rounded-[3px] border border-[#e3e3e0] p-4">
            <div className="text-2xl font-bold text-[#18181b]">15 hrs</div>
            <div className="text-[10px] text-[#37352f] font-medium mt-1 uppercase">Weekly Time Saved</div>
