...
import { Cloud, Laptop, Code2, Sparkles, Server, Workflow } from 'lucide-react';
        ...
        <div className="bg-purple-500/5 p-5 rounded-xl border border-purple-500/20 lg:col-span-1 h-full">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 space-y-4 text-sm text-muted-foreground">
              <p>Build beautiful visual web apps like dashboards or landing pages instantly.</p>
        ...
        <div className="bg-blue-500/5 p-5 rounded-xl border border-blue-500/20 lg:col-span-2 h-full">
          <div className="flex flex-col h-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-semibold leading-tight">Logic & Production Tools</h4>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
              <div className="bg-background p-4 rounded-lg shadow-sm border border-border">
                 ...
                 <p className="text-xs text-muted-foreground leading-relaxed">
                   For robust, scalable, production-ready apps. Generates a 'Blueprint' for review before deploying securely to Google Cloud.
                 </p>
              </div>
              <div className="bg-background p-4 rounded-lg shadow-sm border border-border">
                 <div className="flex items-center gap-2 mb-2 text-blue-600 dark:text-blue-400 font-medium text-sm">
                 ...
                 <p className="text-xs text-muted-foreground leading-relaxed">
                   The All-In-One Workshop. Perfect for logic-heavy apps, bots, and backends. Generates full projects from a single prompt.
                 </p>
              </div>
            </div>
          </div>
