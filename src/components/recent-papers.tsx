      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {recentPapers.map((paper, index) => (
            ...
            >
              <div className="flex h-full flex-col justify-between overflow-hidden rounded-lg border bg-card p-3 transition-colors duration-200 hover:border-primary/50">
