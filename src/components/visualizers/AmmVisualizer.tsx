...
export function AmmVisualizer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-lg border border-slate-200 shadow-sm my-12 w-full font-sans gap-8">
      ...
      <div className="flex gap-16 p-10 bg-white rounded-lg border border-slate-200 shadow-sm items-end justify-center w-full max-w-2xl">
        <div className="flex flex-col items-center gap-4">
          <div className="font-semibold text-slate-900">ETH Reserve (x)</div>
          <div className="w-24 h-[300px] bg-slate-100 rounded-lg flex items-end overflow-hidden relative">
            <div 
      ...
      <div className="font-mono text-xl bg-white px-6 py-3 rounded-lg border border-slate-200 shadow-sm">
      ...
      <div className="flex gap-4">
        <button 
          onClick={resetPool}
          className="px-6 py-3 rounded-lg font-semibold bg-white text-slate-900 border border-slate-200 hover:bg-slate-50 hover:-translate-y-0.5 transition-all"
        >
          Reset Pool
        </button>
        <button 
          onClick={handleSwap}
          disabled={eth >= 250}
          className="px-6 py-3 rounded-lg font-semibold bg-slate-900 text-white hover:bg-slate-800 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:hover:translate-y-0"
        >
