...
export function GitVisualizer() {
  ...
  const steps = ["git init — Create a new repository.","git add + git commit — Save a snapshot of your changes.","git branch feature — Create a parallel line of development.","git merge feature — Combine the branch back into main."];

  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-2xl border border-slate-200 shadow-sm my-12 w-full font-sans gap-8">
      <div className="text-center">
        <h3 className="text-2xl font-bold text-slate-900 tracking-tight">Git</h3>
        <p className="text-slate-500 mt-2">Distributed version control — track every change to your code.</p>
      </div>
