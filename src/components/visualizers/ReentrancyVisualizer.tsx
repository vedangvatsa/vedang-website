...
export function ReentrancyVisualizer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-lg border border-slate-200 shadow-sm my-12 w-full font-sans gap-10">
      ...
      <div className="flex gap-12 items-center justify-center bg-white p-10 rounded-lg border border-slate-200 shadow-sm w-full max-w-3xl">
        <div className="flex flex-col items-center w-[220px] p-6 rounded-lg border-2 border-blue-600 shadow-[0_4px_20px_rgba(10,102,194,0.15)] bg-white">
        ...
        <div className="flex flex-col items-center w-[220px] p-6 rounded-lg border-2 border-rose-600 shadow-[0_4px_20px_rgba(225,29,72,0.15)] bg-white">
      ...
      <div className="flex gap-4">
        <button onClick={reset} disabled={isAnimating} className="px-6 py-3 rounded-lg font-semibold bg-white text-slate-900 border border-slate-200 hover:bg-slate-50 transition-all disabled:opacity-50">Reset</button>
        <button onClick={handleAttack} disabled={isAnimating || vBal === 0} className="px-6 py-3 rounded-lg font-semibold bg-rose-600 text-white hover:bg-rose-700 transition-all disabled:opacity-50">Execute Attack</button>
      </div>
    </div>
  );
}