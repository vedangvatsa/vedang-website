...
export function RestApiVisualizer() {
  ...
  const steps = ["GET /users — Retrieve a list of users.","POST /users — Create a new user.","PUT /users/42 — Update user 42.","DELETE /users/42 — Remove user 42."];

  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-2xl border border-slate-200 shadow-sm my-12 w-full font-sans gap-8">
      <div className="text-center">
        <h3 className="text-2xl font-bold text-slate-900 tracking-tight">REST API</h3>
        <p className="text-slate-500 mt-2">Stateless HTTP endpoints for reading and writing data.</p>
      </div>
