...
export function TcpIpVisualizer() {
  ...
  const steps = ["Application Layer — HTTP, FTP, DNS (your browser lives here).","Transport Layer — TCP splits data into packets, ensures delivery.","Internet Layer — IP addresses and routes packets across networks.","Link Layer — Physical transmission via Ethernet, WiFi, fiber."];

  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-2xl border border-slate-200 shadow-sm my-12 w-full font-sans gap-8">
      <div className="text-center">
        <h3 className="text-2xl font-bold text-slate-900 tracking-tight">TCP/IP</h3>
        <p className="text-slate-500 mt-2">The fundamental protocol stack that powers the internet.</p>
      </div>
