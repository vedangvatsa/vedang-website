...
<KnowledgeCheck 
    ...
    options={[
        "Chatbots are text-only, while agents can generate images.",
        "Chatbots provide information based on prompts, while agents autonomously execute actions to achieve a goal.",
        "Chatbots require programming knowledge to use, while agents are plug-and-play.",
        "There is no difference; they are just marketing terms for the same technology."
    ]}
