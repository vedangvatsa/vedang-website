    ...
    <AccordionItem value="item-1">
        ...
        <AccordionContent className="prose dark:prose-invert max-w-none text-base">
            ...
            <ul>
                ...
                <li><strong>Strong Permissions and Sandboxing:</strong> Agents must operate in sandboxed environments with clearly defined permissions. An agent tasked with reading news should not have permission to access your email or make purchases.</li>
