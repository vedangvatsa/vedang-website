...
<KnowledgeCheck 
    ...
    options={[
        "The more tools an agent uses, the slower it becomes.",
        "Agents must trust tools to be useful, but trusting tools creates a significant security vulnerability.",
        "Humans prefer to use tools directly rather than delegating them to agents.",
        "There are too many tools available, making it impossible for agents to choose the right one."
    ]}
