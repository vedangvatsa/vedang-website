            ...
            <ul>
                <li>
                    ...
                    <ul className="my-2">
                        ...
                        <li><strong>Tree of Thoughts (ToT):</strong> A more advanced technique where the agent explores multiple reasoning paths simultaneously, like branches of a tree. It can evaluate different approaches and backtrack if a path leads to a dead end, making it more strong for problems with many possible solutions.</li>
