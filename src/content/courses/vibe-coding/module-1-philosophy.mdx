...
<Accordion type="single" collapsible className="w-full mt-4">
  <AccordionItem value="q1">
      <AccordionTrigger className="text-lg">What is the primary difference between a traditional coder and a "vibe coder"?</AccordionTrigger>
  ...
  <AccordionItem value="q2">
      <AccordionTrigger className="text-lg">In the GCES framework, why is the "Context" step so important?</AccordionTrigger>
      <AccordionContent className="text-base text-muted-foreground border-l-4 border-primary/50 pl-4">
  ...
  <AccordionItem value="q3">
      <AccordionTrigger className="text-lg">If you want the AI to build a pricing table, what is the fastest way to ensure it looks exactly the way you want?</AccordionTrigger>
      <AccordionContent className="text-base text-muted-foreground border-l-4 border-primary/50 pl-4">
