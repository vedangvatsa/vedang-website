...
<KnowledgeCheck questions={[
  {
    q: "What is the primary difference between a traditional coder and a 'vibe coder'?",
    a: "A traditional coder writes the actual syntax (the 'how'). A vibe coder acts as a director, providing the vision and constraints (the 'what' and 'why') while the AI writes the syntax."
  },
  {
    q: "In the GCES framework, why is the 'Context' step so important?",
    a: "Context tells the AI who the users are and why the product exists. This stops the AI from making generic assumptions and ensures the tone, design, and logic fit the specific situation."
  },
  {
    q: "If you want the AI to build a pricing table, what is the fastest way to ensure it looks exactly the way you want?",
    a: "Use the 'Source' step of the GCES framework. Provide a reference image or a link to a website (like Stripe) that has a design you admire. AI models learn fastest from examples."
  }
]} />
