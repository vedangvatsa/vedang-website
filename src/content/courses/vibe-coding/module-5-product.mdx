...
- [ ] Does every button and link work?
- [ ] What happens when you submit empty input?
- [ ] What happens when you submit extremely long input?
- [ ] Does the app work on mobile (test in Chrome DevTools)?
- [ ] What happens when the API is slow or returns an error?
- [ ] Can a user break the app by clicking the submit button 20 times quickly?
