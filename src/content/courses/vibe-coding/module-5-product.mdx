...
<KnowledgeCheck questions={[
  ...
  {
    q: "What is a 'Product Engineer' and how does this role differ from a traditional developer?",
    a: "A Product Engineer combines product management, design, and engineering. Instead of writing code line-by-line, they find problems, design solutions, and direct AI agents to build the code. The focus is on building great products, not writing syntax."
  }
]} />
