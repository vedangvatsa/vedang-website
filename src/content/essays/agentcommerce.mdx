...
The rapid growth of these layers is visible in tracking the startup ecosystem. According to the **Agentic Commerce Market Map** by [Artemis Analytics](https://www.artemis.xyz/dashboard/agentcommerce/market-map), there are already over 173 companies operating across 14 distinct categories in the space. 
...
The market is currently heavily weighted toward foundational infrastructure rather than consumer-facing apps, indicating an active building phase:
