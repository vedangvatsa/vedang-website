...
These figures are not the same object. Mordor counts a retail-AI market. Morgan Stanley and Bain count US agent-driven e-commerce. McKinsey counts global transaction volume that an agent might touch. Do not stack them.
