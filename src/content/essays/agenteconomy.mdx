...
In January 2024, the AI agent market stood at approximately $5.1 billion. By early 2026, estimates from MarketsandMarkets and BCC Research placed it at $7.5 billion, with projections exceeding $50 billion by 2030. Those are paid analyst models, not a public census. The growth rate they publish, 33-46% compound annually, is a forecast range. A [PwC survey of 308 US executives](https://www.pwc.com/us/en/tech-effect/ai-analytics/ai-agent-survey.html) in April 2025 found 79% saying AI agents were already being adopted in their companies. That is a US executive sample, not a global production census, and PwC's own write-up notes that adoption is often shallow. Something structural has still changed: software now operates on people's behalf.
...
<StatRow>
<Stat value="$7.5B" label="Agent market (2025, analyst estimate)" source="MarketsandMarkets / BCC Research" />
<Stat value="$50B+" label="Projected by 2030 (analyst estimate)" source="BCC Research" />
<Stat value="33-46%" label="Compound annual growth (forecast range)" source="MarketsandMarkets / BCC Research" />
