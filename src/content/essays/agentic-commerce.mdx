...
<StatRow>
<Stat value="$175B" label="Projected market by 2030" source="Mordor Intelligence" />
<Stat value="54%" label="US adults using AI agents" source="PYMNTS, Jan 2026" />
<Stat value="24%" label="Trust agents to buy for them" source="Forrester, Mar 2025" />
<Stat value="13%" label="Have completed an AI purchase" source="Payments Industry Intel" />
</StatRow>
...
<StatRow>
<Stat value="$3-5T" label="Projected transaction volume by 2030" source="Commercetools" />
<Stat value="30.2%" label="Compound annual growth rate" source="Mordor Intelligence" />
<Stat value="+450%" label="Dark web AI exploit discussions" source="Visa, Fall 2025" />
<Stat value="+25%" label="Malicious bot transactions (global)" source="Visa, Fall 2025" />
</StatRow>
