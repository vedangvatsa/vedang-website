...
[Gartner](https://www.gartner.com/en/newsroom/press-releases) projects that the share of enterprise applications embedding task-specific AI agents will grow from under 5% in 2025 to 40% by the end of 2026. That is an architectural change. The application moves from a tool that humans operate to a platform that agents consume, so the API becomes the product and the interface becomes optional.
