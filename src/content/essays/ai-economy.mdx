...
[Daron Acemoglu of MIT](https://economics.mit.edu/people/faculty/daron-acemoglu) has argued that generative AI may produce a modest GDP increase of only 1.1 to 1.6% over the next decade. He estimates that only about 4.6% of tasks can be meaningfully impacted in the near term. Goldman Sachs [has responded](https://www.aei.org/articles/) that Acemoglu's assumptions are based on current capabilities, which are advancing at a pace that makes static projections risky.
