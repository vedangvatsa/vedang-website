...
summary: "Sovereign funds are financing AI compute with equity, convertibles, and bank debt. Stargate, MGX, G42, Saudi Arabia, and SoftBank each put three figures on the table — announced, funded, and spent — and the gap between them reveals who carries the risk."
date: "2026-08-12"
author: "Vedang Vatsa"
...
The largest AI compute projects of the past two years draw sovereign money, convertibles, and bank debt. The public discussion treats the announcements as investment, but three separate figures — announced, funded, and spent — rarely match. Each instrument shows who carries the risk when the numbers don't reconcile.

Five actors sit at the centre of sovereign AI finance. Stargate, the US joint venture with a $500 billion ceiling. MGX, Abu Dhabi's AI investment vehicle. G42, the Emirati AI group that trades capital and compliance for chip licences. Saudi Arabia's Public Investment Fund, still shaping a dedicated AI envelope. SoftBank, the debt engine behind much of Stargate's reported structure. A smaller Indian case, the Sarvam compute subsidy under IndiaAI, is the same accountability question at a different scale.
...
| Initial investment frame | $100 billion | [The Information](https://www.theinformation.com/articles/openai-softbank-each-commit-19-billion-to-stargate-data-center-venture) |
| SoftBank and OpenAI each | $19 billion pledged, 40% each | [The Information](https://www.theinformation.com/articles/openai-softbank-each-commit-19-billion-to-stargate-data-center-venture) |
| Oracle and MGX each | $7 billion pledged | [The Information](https://www.theinformation.com/articles/openai-softbank-each-commit-19-billion-to-stargate-data-center-venture) |
...
States also enter for industrial policy. Chip licences, local jobs, and "sovereign AI" speeches all travel better than bond prospectuses. The financing stack behind the speech can still be ordinary project finance. Separating the speech from the stack is the point.
