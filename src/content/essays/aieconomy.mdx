...
This is where the picture gets genuinely complicated. A [March 2026 Goldman Sachs note](https://www.goldmansachs.com/insights/articles/generative-ai-could-raise-global-gdp-by-7-percent) found no meaningful relationship between AI adoption and economy-wide productivity at the aggregate level. But firms that measured AI impact on specific tasks reported a median productivity gain of around 30%.
...
Universal basic income has moved from thought experiment to active testing. The [Stanford Basic Income Lab](https://blogs.lse.ac.uk/businessreview/) counts over 160 UBI pilots across four decades. The empirical evidence is more nuanced than either advocates or critics tend to acknowledge.
...
The second question that may matter is whether the entry ramp to skilled careers survives. If AI removes the tasks that junior lawyers, junior analysts, and junior developers used to learn on, the pipeline of experienced professionals could thin over time. This is a slow-moving problem that looks invisible in quarterly data but could transform entire professions over a decade.
