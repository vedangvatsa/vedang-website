...
<StatRow>
<Stat value="$175B" label="Smart home market (2025, one analyst band)" source="MarketsandMarkets range; scope-dependent" sourceUrl="https://www.marketsandmarkets.com/" />
<Stat value="1.25B" label="Annual device shipments (2026, circulating est.)" source="Vendor/analyst notes, not a customs census" />
<Stat value="47 sec" label="Mean screen attention (Gloria Mark)" source="APA interview, 2023" sourceUrl="https://www.apa.org/news/podcasts/speaking-of-psychology/attention-spans" />
<Stat value="6h 45m" label="Average daily screen time (often-cited)" source="DataReportal / similar compilations" />
</StatRow>
