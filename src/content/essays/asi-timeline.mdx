...
summary: >-
  ...
  2100+, what the key bottlenecks are (compute, data, architecture, alignment),
  and what the shift from brute-force scaling to research-driven progress
  means for the timeline.
date: '2026-01-15'
author: 'Vedang Vatsa'
