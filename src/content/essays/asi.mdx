...
The date decides how much time the safety people actually have.

I am only arguing about the year. The word is defined [here](/singularity). The claim that a precise picture of the other side is already false is [here](/paradox).
...
If the median is 2032, preparing as though it could be 2028 is cheap relative to preparing as though it is 2060. A median is a bound. It is not a birthday.
</Callout>
