...
AI systems designed to **teach** empathy, helping people on the autism spectrum read social cues, allowing therapy patients to practice difficult conversations in a safe environment, training conflict mediators through realistic simulations, use the same underlying technology for fundamentally different purposes. The goal is a practice environment that improves the user's capacity for empathy with other humans.
