...
Venture capital deal counts have fallen sharply since 2021. By every classical model, that should mean smaller rounds and compressed valuations. The opposite happened. Across 795,924 financing rounds tracked from 2015 through mid-2026, median check sizes hit all-time highs in every early stage: Pre-Seed, Seed, Series A, and Series B. The top 1% of transactions now absorb more than 90% of all private capital in this corpus, pushing the Gini coefficient to 0.916. Fewer deals. Larger checks. Public dollar totals can still print records when AI mega-rounds swallow the rest. The [PitchBook-NVCA Venture Monitor](https://nvca.org/research/pitchbook-nvca-venture-monitor/) put US venture investment above $400 billion in the first half of 2026, already past every previous full year, while repeating the same concentration warning.

## I. Executive Abstract and the Check Size Paradox

The round counts, medians, and Gini figures below come from a proprietary corpus of 795,924 financing events from 2015 through mid-2026. They are not a PitchBook, Crunchbase, or NVCA table republished here. Public monitors ([PitchBook-NVCA Venture Monitor](https://nvca.org/research/pitchbook-nvca-venture-monitor/), [Crunchbase](https://news.crunchbase.com/)) show the same direction: larger checks, more of the dollars in fewer names. NVCA's H1 2026 US print was a dollar record, not a deal-count boom. Where a public series prints a different level, treat the 0.916 Gini as one measurement on one corpus, not an official market index.

This is the Check Size Paradox. GPs did not retreat. They retired spray-and-pray. Capital now sits on a barbell: large reserves in a small set of winners, almost nothing for mid-market software. Gini of 1.0 is one company taking every dollar. Gini of 0.0 is even split. 0.916 in this corpus is the peak of the series. Founders still raising on a ZIRP playbook hit the wall at Seed-to-Series A. GPs now underwrite unit economics, not narrative scale.
...
Valuation multiples expanded to historic, highly speculative levels. Software companies regularly commanded pre-money valuations exceeding 100x ARR, with some frontier enterprise rounds priced at 150x or even 200x forward revenue. The median check size across all stages inflated rapidly. In 2021, this corpus recorded $1.41 trillion across 68,757 transactions. That is a corpus total, not a PitchBook or NVCA global VC print. Public VC monitors for 2021 sit well below $1 trillion. Treat the gap as coverage difference, not a second official market size. This massive injection of cash created a synthetic environment where companies with structurally unviable unit economics were kept solvent through continuous, non-dilutive capital injections. 
...
This institutional migration has completely transformed the Pre-Seed stage. In 2026, the median Pre-Seed check has reached $500,000, representing a 4.2x expansion since 2015. Underwriting at this stage is no longer casual. Founders are now expected to demonstrate early working software, detailed architectural specifications, and initial customer verification before a professional investor will sign a check. The casual "idea-stage" Pre-Seed round has been systematically erased.
...
This dramatic growth is driven by a structural shift in investor behavior. As Series A underwriting criteria hardened, General Partners realized that early-stage startups required significantly more capital and runway to build the strong metrics necessary to clear the next financing hurdle. Instead of funding a company for 12 to 18 months, Seed investors now underwrite for a 30 to 36-month operational runway.
...
The underwriting bar for a Series A in 2026 is exceptionally high. Startups are generally expected to demonstrate at least $2.50 million to $5.00 million in ARR, a net new ARR growth rate exceeding 100% year-over-year, high customer retention metrics, and a highly efficient capital burner index. The Series A is no longer a milestone for establishing early commercial scaling; it is now reserved for companies that have demonstrated highly repeatable, highly predictable market dominance.
...
Because the transition timelines between Pre-Seed, Seed, and Series A have stretched significantly, founders should avoid the historical playbook of raising an 18-month runway and returning to the market within 12 months. Startups should systematically architect a 30 to 36-month operational runway. This extended runway provides the founding team with the necessary time to build the strong, repeatable financial metrics required to clear the high underwriting bar at the next stage, completely insulating the business against short-term capital market volatility.
