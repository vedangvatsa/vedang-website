...
Venture capital deal volume has collapsed by over 50% since 2021. By every classical model, that should mean smaller rounds and compressed valuations. The opposite happened. Across 795,924 financing rounds tracked from 2015 through mid-2026, median check sizes hit all-time highs in every early stage: Pre-Seed, Seed, Series A, and Series B. The top 1% of transactions now absorb more than 90% of all private capital deployed globally, pushing the venture capital Gini coefficient to 0.916. Less money is flowing, but the money that flows is concentrating into fewer, larger bets at a rate never previously recorded.
