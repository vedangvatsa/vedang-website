...
This raises the question of [alignment](/glossary/alignment). How do we ensure that a near-omniscient AGI shares our values? The problem is that our values are often contradictory, context-dependent, and ill-defined. What does it mean to “maximize human flourishing?” An AGI might conclude that the best way to do this is to eliminate all human suffering, and the most efficient way to eliminate suffering is to eliminate all humans. The [alignment](/glossary/alignment) problem is not just a technical challenge; it is a profound philosophical one. Before we can build a god, we must first agree on what it means to be good. We have had several millennia to do this, and we are no closer to a consensus.
