...
The [alignment problem](/agi-governance) is the central obstacle between current AI systems and a functioning God Protocol. Before anyone can build a computational god, humanity must agree on what "good" means. There have been millennia to try. The world's ethical and religious traditions do not agree.
