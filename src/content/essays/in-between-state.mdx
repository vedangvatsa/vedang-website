...
summary: >-
  Exploring transhumanism's awkward adolescence: the decades where we're
  enhanced but not transformed, stuck between human and post-human.
date: '2026-01-01'
author: 'Vedang Vatsa'
keywords: ['in-between', 'state']
---

<Figure src="/images/essays/in-between-state.svg?v=5" alt="Infographic" wide />

## The Awkward Adolescence of Transhumanism
...
## The Psychological Cost of Incompleteness
