...
This is a real market. [ChatGPT Plus](https://help.openai.com/en/articles/6950777-what-is-chatgpt-plus) still costs $20 a month. [ChatGPT Pro](https://help.openai.com/en/articles/9793128) is listed as $100 or $200, depending on usage allowance. Pay per token through an API and dial the list price up or down by picking a model name.
...
The market is simple. More intelligence costs more. The cheapest models are fast and broad: they answer emails, summarize documents, rewrite code comments, and generate first drafts. They are good enough when being right 9 times out of 10 is acceptable. The stronger models cost more because they use more compute. They think in longer chains and hold up better in math, law, medicine, and strategy, where a wrong answer is expensive.
...
The next decade will be less about 1 giant AI and more about specialized intelligences you hire for specific tasks: a contract reviewer, a medical research assistant, a coding partner, a strategy analyst, a writing coach. Some cheap, some expensive, all on demand.
...
In rich countries, cheap calories came first, then flavor. Transport got cheaper, then faster. Communication got cheaper, then clearer. Access to a second pass of reasoning is getting cheaper. When that is cheap, attention will move again.
...
We spent most of history hunting for smart people to help us think. Now we can rent a second pass by the minute. What matters is what we do with it.
