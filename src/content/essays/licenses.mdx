...
Meta's Llama 4 blog on 5 April 2025 called Scout and Maverick [open-weight](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) in the first line, then talked about a "commitment to open source." The file that actually ships is the [Llama 4 Community License](https://github.com/meta-llama/llama-models/blob/main/models/llama4/LICENSE). Apache and MIT are other files, not this one. If your product, or your affiliates', crossed 700 million monthly active users last calendar month, you ask Meta for a second licence. Meta can say no.
