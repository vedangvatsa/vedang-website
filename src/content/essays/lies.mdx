...
A [2025 Bright Defense page](https://www.brightdefense.com/) circulating in security blogs claims that only **0.1% of participants** could correctly distinguish real from synthetic media across formats. I have not found a peer-reviewed paper with that exact rate. For high-quality video, human detection in published lab work is often near chance. Treat the 0.1% figure as a vendor talking point until a methods section exists. For high-quality video deepfakes, human detection accuracy drops to 24.5%. For images, it hovers around 62%. For audio, participants reported 73% confidence in their judgments, but their actual accuracy was significantly lower.
...
Deepfake-driven fraud attempt growth is another vendor circuit. Keepnet and similar firms publish **3,000%** spikes between 2022 and 2024. The **$547 million** H1 2025 US loss figure and the **40% of biometric fraud** claim travel with them. None of those is an FTC annual total I can tie to a filing. The direction is real. The decimals are marketing.
