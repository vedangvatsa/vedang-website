...
<Figure src="/images/essays/post-scarcity-technology.svg?v=8" alt="Post-Scarcity Technology Infographic showing three vectors of deflation: Intelligence, Energy, and Digital Goods converging on Structural Deflation" wide />
...
<PullQuote>
The post-scarcity challenge is not "how does one produce enough?" The industrial revolution answered that question. The challenge is "how to distribute the value of abundance when the traditional distribution mechanism, wages for labor, no longer scales with output?"
</PullQuote>
