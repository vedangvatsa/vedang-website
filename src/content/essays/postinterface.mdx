...
Bots took more than half the web in 2024. [Imperva's 2025 Bad Bot Report](https://www.imperva.com/blog/2025-imperva-bad-bot-report-how-ai-is-supercharging-the-bot-threat/) put automated traffic at 51%, and that is the first time in a decade people lost the majority. We have talked to computers through a GUI since the Xerox Alto in 1973. That job is slipping. [Gartner](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027) says 33% of enterprise apps will include agentic AI by 2028, up from under 1% in 2024. Their IT Symposium/Xpo 2025 figure, via [Digital Commerce 360](https://www.digitalcommerce360.com/2025/11/28/gartner-ai-agents-15-trillion-in-b2b-purchases-by-2028/), is more than $15 trillion in B2B spend going through agents by 2028. Treat that as a forecast. Nobody has counted the money yet. What I can see is the medium: fewer pages built for eyes, more feeds built so a machine can actually use them.

<Figure src="/images/essays/postinterface.svg?v=3" alt="Diagram: pages for people on the left, APIs for machines on the right, both backed by the same database" wide />
...
<PullQuote>You cannot buy a banner impression from an agent. The product has to win on the specs and reviews the agent can parse.</PullQuote>
...
<PullQuote>The companies winning the next decade are building the dark fiber that connects intent engines to fulfillment endpoints.</PullQuote>
...
This alters enterprise software economics. Incumbent platforms historically maintained customer retention through complex visual workflows requiring substantial employee training. When headless alternatives offer programmatic API access that autonomous agents can utilize immediately, proprietary graphical interfaces cease to function as switching barriers.

## The B2B SaaS Transition
...
## Hardware Evolution and Ambient Devices

The emergence of ambient and voice-directed agents shifts hardware design priorities.

For fifteen years, consumer hardware engineering prioritized high-resolution multi-touch displays optimized for manual graphical navigation. 

As conversational interfaces and intent-prediction models mature, personal computation increasingly incorporates ambient and wearable form factors designed for passive context capture rather than active screen manipulation.
...
<KeyTakeaway>
As software consumption shifts from visual graphical interfaces to automated machine-to-machine interactions, commercial viability depends on programmatic API accessibility, structured data protocols, and verifiable execution rails rather than frontend interface moats.
</KeyTakeaway>
