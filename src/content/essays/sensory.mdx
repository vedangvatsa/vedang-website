...
<Figure src="/images/essays/sensory.svg?v=7" alt="Infographic" wide />
...
Each missing sensory channel is a fidelity gap between digital and physical experience. The sensory internet is the project of closing these gaps, channel by channel, until digital experiences approach the full bandwidth of physical ones.

## Haptic Technology: Teaching the Internet to Touch

The haptic technology market reached **$4-12 billion in 2025** (estimates vary by scope: hardware-only vs. hardware plus software), with projections reaching $8-14 billion by 2030. Growth is driven by gaming, automotive HMI, surgical simulation, and XR applications.
...
<PullQuote>
The screen is a window. Spatial computing replaces the window with the room itself. Digital objects occupy physical space, respond to physical light, and can be manipulated with physical gestures. The interface occupies the same room instead of sitting between you and it.
</PullQuote>
...
The BCI market reached approximately **$2.3-3 billion in 2025**, with projections of **$13-15 billion by 2035**. The competitive field is bifurcating:
...
The longer-term trajectory (10+ years) is bidirectional neural interfaces that provide communication in both directions: brain-to-device (control) and device-to-brain (sensation). This would create a new medium. Information would go directly into sensory cortex, skipping eyes and ears. Touch, temperature, spatial awareness, and potentially novel sensory modalities that have no biological equivalent could be delivered directly.

## The Sensory Internet Stack

The sensory internet is a stack of technologies that, layered together, close the gap between digital and physical experience.
...
The sensory internet creates categories of experience that screens and speakers cannot produce.
...
<KeyTakeaway>
Vision Pro proved the pixels and then sold 45,000 units in 2025. Meta kept 60-80% of headset sales at $499 and still cannot put weight in your hand. Presence needs ~60 pixels per degree, haptic latency under 23ms, motion-to-photon under 20ms, and 90+ fps, together, on a face people will wear past twenty minutes. Until that stack ships as one device, surgical simulators and rehab are the buyers that can pay for the missing channel. Clothing returns stay at 25-30% until the fabric has a texture.
</KeyTakeaway>
