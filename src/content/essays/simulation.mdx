...
In 2003, Oxford philosopher Nick Bostrom published a three-page paper in *Philosophical Quarterly* that created a problem no one has been able to dismiss. The [paper is here](https://www.simulation-argument.com/simulation.pdf). The argument is simple: if any civilization ever builds the ability to simulate conscious minds, and if they run even a modest number of such simulations, then the majority of all conscious experiences in the universe are simulated ones. By straightforward probability, you are almost certainly inside one of them.
...
The argument does not claim that this reality is a simulation. It claims that one of the three propositions must be true. Each premise carries substantial uncertainty.
