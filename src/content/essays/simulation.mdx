...
In 2003 Nick Bostrom published a three-page argument ([PDF](https://www.simulation-argument.com/simulation.pdf)) that still eats lunch on Reddit. His claim is statistical, not mystical. If a civilization can simulate its ancestors at scale, and if it chooses to, simulated minds outnumber biological ones. You might be in the majority.
...
Run enough ancestor sims and the headcount flips. Billions of minds per copy. One civilization doing this seriously puts most observers inside software. Pick a random conscious being and you are probably in a copy, unless propositions 1 and 2 are true.

Bostrom does not say this world is fake. He says one of the three propositions must be true. Each one is still a guess.
