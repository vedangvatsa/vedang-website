...
In August 1965 Malaysia expelled Singapore. Per capita GDP was about $500 in today's dollars. Lee Kuan Yew announced the split on television and cried. The island imported food, water, and fuel. The population was about 2 million, Chinese, Malay, Indian, and others, with no shared national story yet.

<Figure src="/images/essays/singapore.svg?v=7" alt="The Economic Miracle Infographic" wide />
...
How it happened has occupied development economists for decades. The answer is a set of interlocking institutional choices made under extreme pressure, several of which ran against the prevailing economic orthodoxy of their time, and most of which produced measurable results within a generation.
...
The institutional design point is worth isolating. Most countries treat anti-corruption as a criminal justice problem. Singapore treated it as a market design problem. If corruption generates higher returns than honest service, rational actors may choose corruption. The intervention was to change the payoff structure, not the enforcement intensity alone. This is a framework that may be replicable even if the specific salary levels are not.
...
The design principle is that individuals bear enough of the cost to avoid frivolous consumption, while the state ensures no one goes without necessary care. The co-payment structure is a response to a specific problem: how to achieve universal coverage without the fiscal burden that makes single-payer systems politically fragile in aging societies.
...
That is the same playbook as semiconductors and finance: pick the next value layer, build the agency before rivals, park global firms there, train for the shift. Whether AI pays the same way is open. The method is not.
...
The **transferable** elements are more interesting. Competitive government salaries reduce corruption by changing the incentive structure, not the punishment structure alone. Public housing structured to create property owners creates a citizenry with a measurable economic stake in national stability. Adaptive industrial policy that moves up the value chain as wages rise, rather than defending incumbent industries, prevents the middle-income trap. Mandatory savings systems fund healthcare and retirement without pay-as-you-go fiscal burdens. Active ethnic integration in housing and military service prevents the self-sorting that produces segregated communities over time.

<KeyTakeaway>
Steal the pieces that travel: pay civil servants enough to make theft stupid, house people so they own a stake, move industry before wages trap you. The full package needs a city-state and a long premiership. The pieces do not.
</KeyTakeaway>
