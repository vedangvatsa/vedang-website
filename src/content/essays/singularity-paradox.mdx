...
<PullQuote>
We're trying to predict the behavior of an intelligence that will be smarter than us.
</PullQuote>

The singularity is fundamentally paradoxical.  But if we could predict what a superintelligence will do, it's not superintelligent yet. The moment it becomes truly superintelligent, it escapes our predictions.
