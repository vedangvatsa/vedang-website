...
Even if a superintelligent system's terminal goals are perfectly aligned with human welfare, it may pursue helpful subgoals that conflict with human interests.

Steve Omohundro (2008) and Nick Bostrom identified a set of helpful goals that are useful for achieving almost any terminal goal:

1. **Self-preservation.** A system that is shut down cannot achieve its goals. Therefore, most goal-directed systems have an helpful reason to resist shutdown.
...
3. **Self-improvement.** A more capable system is better at achieving its goals. Therefore, most goal-directed systems have an helpful reason to enhance their own capabilities.
