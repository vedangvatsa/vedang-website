...
The singularity is a prediction that undermines prediction. The attempt is to forecast the behavior of an intelligence that, by definition, exceeds the cognitive capacity of the forecaster. If humans could predict what a superintelligence would do, it would not be superintelligent relative to them. The moment it becomes genuinely superintelligent, it escapes existing predictive models.
