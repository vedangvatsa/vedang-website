...
Powerful is not the claim. The claim is a system that can design a better version of itself. I.J. Good called that an "intelligence explosion" in 1965: each generation builds the next, and the gains outrun any ministry, lab board, or statute that tries to keep up.
