...
<PullQuote>
Eventually, no human can predict what the next generation will do, but the transition is gradual enough to adjust course.
</PullQuote>

A soft singularity is slower. AI gradually becomes smarter. Each generation is 50% better than the last. Eventually, no human can predict what the next generation will do, but the transition is gradual enough to adjust course. You have time to build safeguards. Time to align values. Time to negotiate.
