...
In 2021, the Metaculus forecasting platform placed the median prediction for artificial general intelligence in the mid-2040s. By early 2026, that estimate had moved to 2030-2033, a collapse of nearly two decades in under five years. Ray Kurzweil's 2005 prediction that the singularity would arrive around 2045 now looks conservative. The possibility that artificial intelligence surpasses human cognitive ability across every relevant domain, and then begins improving itself recursively, has moved from philosophical thought experiment to an active engineering timeline.
