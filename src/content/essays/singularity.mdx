...
<Figure src="/images/essays/singularity.svg?v=5" alt="Infographic" wide />
...
A soft singularity is slower. AI gradually becomes smarter. Each generation is 50% better than the last.  You have time to build safeguards. Time to align values. Time to negotiate.
