...
*The underlying research paper and methodology are available in the [AI Reports Library](/ailib). All results are derived from the free OpenAlex API using abstract-level keyword search. Every count reported can be independently verified and updated.*
