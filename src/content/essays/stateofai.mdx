...
**The bigram distribution splits cleanly into two tiers.** The top six terms are method-level: neural network, machine learning, deep learning, artificial intelligence, attention mechanism, and large language, totaling **5.37 million abstract mentions**. The bottom four are application-level: image classification, recommendation system, medical imaging, and feature extraction, totaling **1.39 million**. The ratio is 3.9:1. Method vocabulary dominates application vocabulary by nearly four to one.
