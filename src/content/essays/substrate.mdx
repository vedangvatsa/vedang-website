...
Silicon ran computing for seventy years because transistors kept shrinking. At 3nm they are about 12 atoms wide, and electrons leak. Photonic chips, DNA storage, quantum processors, and neuromorphic chips are already in labs and a few products. None of them replaces silicon alone. The stack will mix.

<Figure src="/images/essays/substrate.svg?v=7" alt="Infographic" wide />
...
<StatRow>
<Stat value="3nm" label="TSMC 3nm manufacturing from 2023" source="TSMC" sourceUrl="https://www.tsmc.com/" />
<Stat value="$20-30B" label="Leading-edge fab, widely reported range" source="Public fab-cost reporting; later US fabs ran higher" />
<Stat value="455 EB/g" label="Theoretical DNA density (2 bits/base)" source="Church, Gao, Kosuri, Science 2012" sourceUrl="https://www.science.org/doi/10.1126/science.1226355" />
<Stat value="$100K/MB" label="Early DNA storage cost (order of magnitude)" source="Twist Bioscience / early commercial quotes" />
</StatRow>
...
<PullQuote>
The shift from electrons to photons is about escaping the thermodynamic trap. Light does not generate heat. At data center scale, this difference is existential.
</PullQuote>
