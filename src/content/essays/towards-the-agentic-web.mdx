...
<StatRow>
<Stat value="6,400+" label="Registered MCP servers" source="The Next Web (2026)" sourceUrl="https://thenextweb.com/" />
<Stat value="150+" label="A2A Protocol Adopters" source="Google Developers (2025)" sourceUrl="https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/" />
<Stat value="4" label="Major AI Platforms on MCP" />
</StatRow>

Every major AI platform—OpenAI, Google, Microsoft, and Anthropic—has standardized around MCP. Google then released its own complementary protocol, the [Agent-to-Agent (A2A) protocol](https://a2a-protocol.org/latest/), in April 2025, allowing agents from different vendors to communicate and collaborate with each other. By mid-2025, over 150 organizations including Salesforce, SAP, Atlassian, and PayPal had adopted it. These two protocols together, MCP for connecting agents to tools and A2A for connecting agents to each other, are forming what some call the HTTP layer for the agent era.
...
<StatRow>
<Stat value="50M+" label="Machine-to-machine TXs" source="x402 Protocol" sourceUrl="https://www.coinbase.com/blog/introducing-agentic-wallets" />
<Stat value="0" label="KYC Checks Required" />
</StatRow>

<Callout type="insight" title="The HTTP 402 Revival">
Central to this is the [x402 protocol](https://www.x402.org/), also built by Coinbase, which revives the old HTTP 402 "Payment Required" status code. It allows AI agents to pay for web services automatically using stablecoins, without accounts, without sessions, and without authentication flows. The protocol has already processed over 50 million machine-to-machine transactions.
</Callout>
...
<StatRow>
<Stat value="40%" label="Enterprise apps w/ agents" source="Gartner (2026)" sourceUrl="https://www.gartner.com/en/newsroom/press-releases" />
<Stat value="$50B" label="Agent Market Size by 2030" source="Grand View Research" sourceUrl="https://www.grandviewresearch.com/industry-analysis/ai-agents-market-report" />
<Stat value="79%" label="Orgs deploying AI agents" source="Towards AI" sourceUrl="https://towardsai.net/" />
<Stat value="56%" label="Job tasks accelerated" source="OpenAI / UPenn" sourceUrl="https://arxiv.org/abs/2303.10130" />
</StatRow>

[Gartner predicts](https://www.gartner.com/en/newsroom/press-releases) that by the end of 2026, 40% of enterprise applications will embed task-specific AI agents, up from less than 5% in 2025. The global AI agents market is projected to reach over $50 billion by 2030. 79% of organizations are already deploying AI agents in some capacity, and 88% plan to increase their AI budgets in the next twelve months.
...
<Callout type="warning" title="Security & Sandboxing">
