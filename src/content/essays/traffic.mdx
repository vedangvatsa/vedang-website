...
Kaitlyn Tiffany brought the theory into mainstream coverage with a [September 2021 article in The Atlantic](https://www.theatlantic.com/technology/archive/2021/08/dead-internet-theory-online-community-future/619937/). In 2024, Yoshija Walter argued in [AI and Society](https://doi.org/10.1007/s00146-023-01857-0) that the "once speculative theory" was becoming observable as AI-generated content proliferated. In 2026, Hal Berghel published in [Computer](https://doi.org/10.1109/MC.2025.3616665) what he called a "leaner" version of the theory, "stripped of paranoia, prejudice, politics and polemic." His central argument: dismissing the core observations because conspiracy theorists attach implausible claims to them is "a mistake of the first order."

Then the theory escaped academic journals and entered CEO Twitter feeds. In May 2025, [Bloomberg reported](https://www.bloomberg.com/news/articles/2025-05-08/maybe-ai-slop-is-killing-the-internet-after-all) that tools like ChatGPT and Midjourney had made the theory "look downright prophetic." In September 2025, Sam Altman [posted on X](https://en.wikipedia.org/wiki/Dead_Internet_theory#Evidence) that "there are really a lot of LLM-run twitter accounts now." That same month, [Time magazine](https://en.wikipedia.org/wiki/Dead_Internet_theory#cite_note-9) covered the theory's shift from fringe to mainstream.

In October 2025, [Forbes reported](https://en.wikipedia.org/wiki/Dead_Internet_theory#Evidence) that Ohanian and Altman had both warned the dead internet theory was materializing. Reddit co-founder Alexis Ohanian told [Kevin Rose at TechCrunch Disrupt](https://en.wikipedia.org/wiki/Dead_Internet_theory#Evidence) that "the dead internet theory is real." The trajectory from fringe post to CEO admission took 4 years.
...
In January 2026, Ohanian and Kevin Rose relaunched Digg. It shut down 2 months later, [citing an "unprecedented bot problem."](https://en.wikipedia.org/wiki/Dead_Internet_theory#Evidence) In May 2026, Digg rebranded as an AI news aggregator, stating on its homepage that bots were the reason for the pivot.
...
[The Internet Archive](https://archive.org/about/) has crawled and [preserved the web since 1996](https://en.wikipedia.org/wiki/Internet_Archive). Its crawler obeys robots.txt and does not train AI models. But its crawler consumes the same server resources as AI training crawlers. A well-behaved bot and a training bot impose the same infrastructure cost. The difference is downstream.
