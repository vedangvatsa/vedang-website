...
summary: >-
  Software dashboards grew complex because they had to anticipate every possible
  question a user might ask. When a text field backed by an LLM can answer any
  question by calling internal APIs directly, the dashboard becomes redundant.
  The architectural implications run deeper than most analysts recognize.
date: '2026-04-10'
author: 'Vedang Vatsa'
