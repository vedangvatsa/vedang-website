...
date: '2026-04-04'
author: 'Vedang Vatsa'
keywords: ['Y Combinator', 'YC', 'startup trends', 'AI agents', 'defense tech', 'venture capital', 'B2B SaaS', 'agentic AI']
---

[Y Combinator's public directory](https://www.ycombinator.com/companies) of 5,818 portfolio companies is a leading indicator for where the industry is heading. Five shifts show up in the data: B2B is 51% of the portfolio and near 70% in recent batches. The pitch moved from "AI-powered X" to "AI agent/employee for X." Defense and hard-tech appear at a scale this directory has not shown before. San Francisco's pull intensified despite remote work. Consumer internet, once YC's heartland, is under 15%.

<Figure src="/images/essays/yc-landscape-2026.svg?v=2" alt="YC portfolio 2026" wide />


## Why this dataset matters

YC's selection process is a filter applied to thousands of applications per batch. The companies that pass through reflect founder ambition and the committee's assessment of what is technically feasible and commercially viable with current technology. When the composition shifts, the directory shows what the committee is betting on.

The directory's value is the aggregate, not the famous logos. Individually, each startup is a bet. Collectively, 5,818 of them are closer to a census of where technical talent and venture capital are placing money. Counts below are the full portfolio as of April 2026, with focus on the five most recent batches (W25 through S26).

A caveat is necessary. YC is not a neutral sample of the startup ecosystem. It selects for a specific founder profile (technical, willing to relocate, comfortable with YC's terms). Its batch composition reflects both market reality and its own institutional preferences. When YC funds a category aggressively, other founders notice and build in that space. The directory may amplify trends as well as reflect them. The patterns described here should be read as "what YC is betting on," not as a forecast of what will succeed.


## The B2B supermajority

<Figure src="/images/essays/charts/yc-industry-breakdown.png" alt="Bar chart showing YC portfolio by industry: B2B 50.9% (2,964 companies), Consumer 14.9% (867), Healthcare 11.4% (665), Fintech 10.6% (618), Industrials 6.3% (368), Real Estate 2.6% (153), Education 2.1% (125)" wide />
...
<StatRow>
<Stat value="51%" label="YC portfolio is B2B (Apr 2026 scrape)" source="YC Startup Directory" sourceUrl="https://www.ycombinator.com/companies" />
<Stat value="2,964" label="B2B companies in that scrape" source="YC Directory (Apr 2026)" sourceUrl="https://www.ycombinator.com/companies" />
<Stat value="~70%" label="B2B share in W26/S26 (author count)" source="Same scrape, not a YC census" sourceUrl="https://www.ycombinator.com/companies" />
<Stat value="<15%" label="Consumer share in that scrape" source="YC Directory (Apr 2026)" sourceUrl="https://www.ycombinator.com/companies" />
</StatRow>
...
Most YC companies use AI. The signal is what they promise. The taglines have changed from "AI that helps you do X" to "AI that does X for you." That describes a different product architecture, a different pricing model, and a different labor market thesis.

<TaglineArchaeology />

The Winter 2026 batch makes this concrete. Cranston AI is a "Full Stack AI Accounting Firm." General Legal is "The AI native law firm." Foreman is "Keeping contractors on the job site, not behind a desk." Example Health builds "AI Employees for Primary Care." Copperlane is an "AI Mortgage Loan Officer."

These companies position as staffing replacements. The word "copilot" implies a human doing the work with machine assistance. Based on their public pricing pages, many charge per-task or per-seat rather than via traditional software licenses. Whether the products deliver on that positioning is a separate question from the fact that the positioning itself has shifted.
...
<ResearchPaper
  ...
  abstract="A deep-dive into all eight layers of the agent infrastructure stack, with $5B+ in venture funding data and analysis of capital concentration across perception, orchestration, evaluation, reasoning, memory, sandboxing, security, and deployment."
/>
...
The coverage of verticals is now detailed enough to be its own data point. Legal, healthcare, accounting, construction, insurance, sales, DevOps, and supply chain each have 5 or more YC companies building dedicated AI agents. No major white-collar vertical has been left untouched.
...
When hundreds of funded startups simultaneously target the same job functions, the surviving ones (most will fail) inherit the market insight and technical progress of the cohort. Whether this translates into actual labor displacement depends on execution, regulation, and buyer adoption. Stanford's [Digital Economy Lab](https://digitaleconomy.stanford.edu/publications/canaries-in-the-coal-mine/) has documented a 13-16% decline in early-career employment in AI-exposed occupations since late 2022. That is one research series, not a BLS occupational census. The YC directory is consistent with that direction. Correlation between startup activity and employment outcomes should not be overstated.
...
<StatRow>
<Stat value="12+" label="Named defense cos in 2025-26 batches" source="Author tally from YC directory" sourceUrl="https://www.ycombinator.com/companies?industry=Defense" />
<Stat value="18+" label="Robotics / manufacturing (author tally)" source="YC Directory (Apr 2026 scrape)" sourceUrl="https://www.ycombinator.com/companies?industry=Industrials" />
<Stat value="3x" label="Defense names vs 2024 (author ratio)" source="Same scrape; not a YC census" sourceUrl="https://www.ycombinator.com/companies?industry=Defense" />
<Stat value="8" label="Space and aerospace (author tally)" source="YC Directory (Apr 2026 scrape)" sourceUrl="https://www.ycombinator.com/companies?industry=Industrials" />
</StatRow>
...
New York is second at 8%. India has emerged as the largest non-US geography at 4%, driven by Groww, Razorpay, Meesho, Clear, and Zepto. India's share has held steady despite rising geopolitical complexity around US-India tech relations.
...
What replaced it is the "prosumer agent" category. Meteor (AI-native browser), Blue (AI phone manager), VoiceOS (voice productivity assistant), and April (voice AI assistant) sit between of consumer UX and agent automation. Their value proposition is delegation. The metric that matters is tasks completed per user.
