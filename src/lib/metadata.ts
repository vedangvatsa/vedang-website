...
export const pageMetadata = {
  home: {
    title: 'Vedang - Essays, Research & Profile | veda.ng',
    description:
  ...
  essays: {
    title: 'Essays by Vedang | veda.ng',
    description:
  ...
  web3101: {
    title: 'Web3 101 - Blockchain Fundamentals Course | Vedang',
    description:
  ...
  promptEngineering: {
    title: 'Prompt Engineering 101 - AI Course | Vedang',
    description:
  ...
  community: {
    title: 'Community Building Guide | Vedang',
    description:
  ...
  about: {
    title: 'About Vedang - Bio, Research & Profile | veda.ng',
    description:
  ...
  media: {
    title: 'Speaking Engagements & Media | Vedang',
    description:
  ...
  agenticWeb: {
    title: 'The Agentic Web - AI Agents Course | Vedang',
    description:
  ...
  vibeCoding: {
    title: 'Vibe Coding 101 by Vedang',
    description:
  ...
  seo: {
    title: 'Growth Marketing & SEO Expertise | Vedang',
    description:
  ...
  mcpDev: {
    title: 'MCP Development 101 - Build AI Tool Servers | Vedang',
    description:
  ...
  aiAutomation: {
    title: 'AI Automation 101 - Automate Anything with AI | Vedang',
    description:
  ...
  healthProtocols: {
    title: 'Bryan Johnson Blueprint Protocol - Full Reference Guide | Vedang',
    description:
  ...
  aiReports: {
    title: 'AI Reports & Research Library - 2025-2026 | Vedang',
    description:
  ...
  contact: {
    title: 'Book a Meeting with Vedang',
    description:
  ...
  stateOfWeb3: {
    title: 'The State of Web3 | Vedang',
    description:
  ...
  privacy: {
    title: 'Privacy Policy - veda.ng | Vedang',
    description:
  ...
  developers: {
    title: 'veda.ng Developer Resources - API, MCP Server, Feeds | Vedang',
    description:
